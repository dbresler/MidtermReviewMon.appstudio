...
let secondNumber = prompt ("Please enter a number")
  if (evenNumber == 2,4,6,8,10) {
    alert(`${inputNumber} and ${secondNumber} are even numbers`) 
    } 
  else  (oddNumber == 1,3,5,7,9) {
    alert(`${inputNumber} and ${secondNumber} are odd numbers`)
    }
